...
import static org.richfaces.ui.core.HtmlConstants.ID_ATTRIBUTE;
import static org.richfaces.ui.core.HtmlConstants.STYLE_ATTRIBUTE;
...
public class CollapsiblePanelRenderer extends TogglePanelRenderer {
    ...
    private void encodeHeader(ResponseWriter writer, FacesContext context, AbstractCollapsiblePanel component)
        ...
        writer.writeAttribute(
            ...
            concatClasses("rf-cp-hdr", "rf-cp-hdr-" + (component.isExpanded() ? "exp" : "colps"),
                DivPanelRenderer.attributeAsString(component, "headerClass")), null);
    ...
    private void encodeContent(ResponseWriter writer, FacesContext context, UIComponent component, boolean visible)
        ...
        writer.writeAttribute(CLASS_ATTRIBUTE, concatClasses("rf-cp-b", DivPanelRenderer.attributeAsString(component, "bodyClass")), null);
        writer.writeAttribute(STYLE_ATTRIBUTE, DivPanelRenderer.styleElement("display", visible ? "block" : "none"), null);
